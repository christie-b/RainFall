...
Dump of assembler code for function main:
   ...
   0x0804855a <+49>:	rep stos %eax,%es:(%edi)						; for ecx repetitions (19) stores the contents of eax (0) into where edi points to, incrementing or decrementing edi (depending on the direction flag) by 4 bytes each time
   0x0804855c <+51>:	mov    0xc(%ebp),%eax							; move ebp+12 to eax
