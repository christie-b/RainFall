...
Dump of assembler code for function main:
   ...
   0x0804842d <+9>:		mov    0xc(%ebp),%eax					; move ebp+12 to eax
   0x08048430 <+12>:	add    $0x4,%eax						; eax = eax+4 = ebp+16
   0x08048433 <+15>:	mov    (%eax),%eax
   0x08048435 <+17>:	mov    %eax,(%esp)						; move eax to esp
   ...
   0x0804844f <+43>:	mov    0x3c(%esp),%eax					; move esp+60 to eax
   0x08048453 <+47>:	lea    0x0(,%eax,4),%ecx				; ??
   0x0804845a <+54>:	mov    0xc(%ebp),%eax					; move ebp+12 to eax
   0x0804845d <+57>:	add    $0x8,%eax						; eax = eax+8 = ebp+20
   0x08048460 <+60>:	mov    (%eax),%eax
   0x08048462 <+62>:	mov    %eax,%edx						; move ebp+20 to edx
   0x08048464 <+64>:	lea    0x14(%esp),%eax					; move pointer in esp+0x14 to eax
   0x08048468 <+68>:	mov    %ecx,0x8(%esp)					; move ecx (??) to esp+8
